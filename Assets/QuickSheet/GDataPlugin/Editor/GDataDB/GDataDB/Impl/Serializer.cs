...
namespace GDataDB.Impl
{
    ...
    public class Serializer<T>
    {
        ...
        public object ConvertFrom(object value, Type t, string path = null)
        {
            ...
            else if (t.Equals(typeof(Sprite)) && path != null)
            {
                return AssetDatabase.LoadAssetAtPath<Sprite>("Assets/" + path + "/" + value.ToString() + ".png");
            }
            else
        ...
        public T Deserialize(ListEntry e, string path = null)
        {
            var t = typeof(T);
                ...
                if (property.CanWrite)
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            {
                                value = ConvertFrom(c.Value, property.PropertyType, path);
                            }
