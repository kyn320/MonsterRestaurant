...
/// 
[System.Serializable]
public class DB_Item_Equip : ScriptableObject 
{
   ...
   [SerializeField]
    ...
    public DB_Item_EquipData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new DB_Item_EquipData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public DB_Item_EquipData FindByKey(string key)
    //{
