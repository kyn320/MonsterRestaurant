...
/// 
[System.Serializable]
public class DB_Item_Material : ScriptableObject 
{
   ...
   [SerializeField]
    ...
    public DB_Item_MaterialData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new DB_Item_MaterialData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public DB_Item_MaterialData FindByKey(string key)
    //{
